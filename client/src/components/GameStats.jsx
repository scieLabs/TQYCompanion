...
export default function GameStats({ formData, setFormData, currentWeek, currentSeason, gameId }) {
  ...
  const saveGameData = async () => {
    try {
      await gameAPI.put(`/games/${gameId}`, formData);
    } catch (error) {
      console.error('Error saving project resolution:', error);
    }
  };
